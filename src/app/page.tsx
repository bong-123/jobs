    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-800 flex flex-col items-center justify-center p-4">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-lg w-full max-w-4xl mb-8">
        ...
        <p className="text-gray-600">
          The Job Application Tracker helps you stay on top of your job hunt by keeping all your applications, interviews, and offers organized in one place. 
          Say goodbye to messy spreadsheets and scattered notes — track your progress smoothly and efficiently.
        </p>
      </div>
      ...
      <button onClick={() => router.push("/job")} className="mt-8 bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-semibold py-2 px-4 rounded-2xl shadow-lg transition-transform transform hover:scale-105">
        Get Started
      </button>
