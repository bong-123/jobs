        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-400 to-pink-400">
            <header className="w-full bg-white shadow p-4 flex justify-between items-center fixed top-0">
                ...
                <nav className="flex gap-4">
                    ...
                    <Link href="/job" className="text-gray-600 font-semibold hover:text-red-800">Jobs</Link>
                    <Link href="#" className="text-gray-600 font-semibold hover:text-red-800">About Us</Link>
                    <Link href="#" className="text-gray-600 font-semibold hover:text-red-800">Log In</Link>
                </nav>
            </header>
            <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md text-black">
                ...
                <p className="text-center mt-3 text-sm">Don't have an account? 
                    <span onClick={() => router.push('/registration')} className="text-purple-600 cursor-pointer">Register</span>
                </p>
            </div>
        </div>
    );
